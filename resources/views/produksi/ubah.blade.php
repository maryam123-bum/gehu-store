        ...
        <div class="row mb-3">
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <input type="hidden" id="id_produksi" value="{{ $header->id }}">
                            <div class="col-2 font-weight-bold">
                                <h6>Kode Produksi</h6>
                            </div>
                            <div class="col-3">
                              <h5><span class="badge bg-light" style="color:#000"><?php echo substr_replace("PRO-000",$header->id,7-strlen($header->id)); ?></span></h5>
                          </div>
                            <div class="col-1"></div>
                            <div class="col-2 font-weight-bold">
                                <h6>Tanggal</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <h6><input type="text" name="nama_barang_produksi" class="d-inline form-control form-control-sm" value="{{ $header->nama_barang }}" id="nama_barang_produksi"></h6>
                            </div>
                            <div class="col-1"></div>
                            <div class="col-2 font-weight-bold">
                              <h6>Jumlah Buat</h6>
