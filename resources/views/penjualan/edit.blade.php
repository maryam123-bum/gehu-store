        ...
        <div class="row mb-3">
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <input type="hidden" id="id_penjualan" value="<?php echo $header['id'];?>">
                            <div class="col-2 font-weight-bold">
                                <h6>Nama Pelanggan</h6>
                            </div>
                            <div class="col-3 mb-2">
                                <input type="text" name="nama_pelanggan" class="d-inline form-control form-control-sm" width="" id="nama_pelanggan" value="<?php echo $header['nama_pelanggan'];?>">
                            </div>
                            <div class="col-1"></div>
                            <div class="col-2 font-weight-bold">
                                <h6>Tanggal</h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="harga" class="mb-2 font-weight-bold">Jumlah Barang</label>
                                <input type="text" class="form-control mb-2" placeholder="0" name="jumlah" id="jumlah">
                            </div>
                            <div class="form-group">
                                <label for="jumlah" class="mb-2 font-weight-bold">Diskon</label>
