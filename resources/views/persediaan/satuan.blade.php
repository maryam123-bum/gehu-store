  ...
  <div class="card">
    ...
    <div class="card-body">
      <form class="needs-validation" action="/tambah/satuan" method="POST" novalidate>
        ...
        <div class="row g-3">
            <div class="col-5">
                <h6><span class="badge bg-light" style="color:#000"><?php echo substr_replace("SAT-000","1",7-strlen("1")); ?></span></h6>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
                <label for="firstName" class="form-label">Nama Satuan</label>
                <input type="text" class="form-control" name="namaSatuan" id="namaSatuan" value="" required>
            </div>
        </div>
